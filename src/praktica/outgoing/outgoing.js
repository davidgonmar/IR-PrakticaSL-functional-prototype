...
export default function Outgoing() {
    ...
    return (
        <>
            <h1 style={{ textAlign: 'center' }}>Outgoing</h1>
            <div className="text-center project-dashboard-page-container">
                ...
                <div style={{
                    ...
                    <div style={{ margin: '10px', width: '30%' }} className="project-image-text">
                        ...
                        <Link to={'project'}><h3 style={{ textOverflow: 'ellipsis', whiteSpace: 'nowrap', overflow: 'hidden' }} className="text-center project-title">project_name_19Dec2018</h3></Link>
                    </div>
                    <div style={{ margin: '10px', width: '30%' }} className="project-image-text">
                        <img style={{ width: '400px', height: '300px', borderRadius: '10px' }} src="https://picsum.photos/id/69/400/300"></img>
                        <Link to={'project'}><h3 style={{ textOverflow: 'ellipsis', whiteSpace: 'nowrap', overflow: 'hidden' }} className="text-center project-title">project_name_27Feb2019</h3></Link>
                    </div>
                    <div style={{ margin: '10px', width: '30%' }} className="project-image-text">
                    ...
                    <div style={{ margin: '10px', width: '30%' }} className="project-image-text">
                        ...
                        <Link to={'project'}><h3 style={{ textOverflow: 'ellipsis', whiteSpace: 'nowrap', overflow: 'hidden' }} className="text-center project-title">project_name_02Oct2021</h3></Link>
                    </div>
                    <div style={{ margin: '10px', width: '30%' }} className="project-image-text">
                        <img style={{ width: '400px', height: '300px', borderRadius: '10px' }} src="https://picsum.photos/id/9/400/300"></img>
                        <Link to={'project'}><h3 style={{ textOverflow: 'ellipsis', whiteSpace: 'nowrap', overflow: 'hidden' }} className="text-center project-title">project_name_06Dec2023</h3></Link>
                    </div>
                    <div style={{ margin: '10px', width: '30%' }} className="project-image-text">
                        <img style={{ width: '400px', height: '300px', borderRadius: '10px' }} src="https://picsum.photos/id/1/400/300"></img>
                        <Link to={'project'}><h3 style={{ textOverflow: 'ellipsis', whiteSpace: 'nowrap', overflow: 'hidden' }} className="text-center project-title">project_name_06Dec2023</h3></Link>
                    </div>
                </div>
